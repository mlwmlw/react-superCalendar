...
/***/ function(module, exports, __webpack_require__) {
	...
	var Times = React.createClass({displayName: "Times",
		...
		render: function() {
			...
			for(var i = 0; i< 12; i++) {
				...
				time.push(React.createElement(Time, {deg: deg, selected: selected, hour: hour, ref: hour}, show));
			}
	...
	var Clock = React.createClass({displayName: "Clock",
		...
		render: function() {
			...
			return React.createElement("div", {onMouseMove: this.move, onMouseDown: this.end, style: mode}, 
