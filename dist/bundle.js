...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Calendar, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeekHead = React.createClass({displayName: "WeekHead",
		render: function() {
			return React.createElement("thead", null, 
						React.createElement("tr", null, 
							React.createElement("th", {className: "picker__weekday"}, "日"), 
							React.createElement("th", {className: "picker__weekday"}, "一"), 
							React.createElement("th", {className: "picker__weekday"}, "二"), 
							React.createElement("th", {className: "picker__weekday"}, "三"), 
							React.createElement("th", {className: "picker__weekday"}, "四"), 
							React.createElement("th", {className: "picker__weekday"}, "五"), 
							React.createElement("th", {className: "picker__weekday"}, "六")
						)
						);
		}
	});
	var WeekFoot = React.createClass({displayName: "WeekFoot",
		render: function() {
			return React.createElement("tfoot", {style: {textAlign:"center"}}, 
							React.createElement("tr", null, 
								React.createElement("td", {colSpan: "7"}, 
									React.createElement("button", {onClick: this.props.prev}, "prev"), 
	...
	var Time = React.createClass({displayName: "Time",
		render: function() {
			...
			return React.createElement("div", {ref: i, itemProp: this.props.hour, key: i, style: {position: "absolute", top: "43%", left: "4%", width: "45%", transformOrigin: "right center", height: "1.5em", transform: "rotate(" + deg + "deg)"}}, 
						React.createElement("span", {style: style}, i)
				)
		}
	});
	var Times = React.createClass({displayName: "Times",
		...
		render: function() {
			...
			for(var i = 0; i< 12; i++) {
				...
				time.push(React.createElement(Time, {deg: deg, selected: selected, hour: hour, ref: hour}, hour));
			}
			return React.createElement("div", {ref: "time"}, time);
		}
	});
	var Clock = React.createClass({displayName: "Clock",
		...
		render: function() {
			...
			return React.createElement("div", {onContextMenu: function(e) { e.preventDefault(); }, onMouseMove: this.move, onMouseDown: this.end, style: mode}, 
				React.createElement("div", {className: "point", style: {background: "#0095dd", borderRadius: 5, width: 5, height: 5, position: "absolute", top: "50%", left: "48.5%", zIndex: 2}}), 
				React.createElement("div", {className: "line", style: {position: "absolute", background: this.state.mode =="hour" ? "#c0e5f7": "gray", height: "3px", borderRadius: "3px", marginTop: "50%", width: "20%", marginLeft: "30%", transform: "rotate(" + h + "deg)", transformOrigin: "right center", transition: "all 0.2s ease"}}
				), 
				React.createElement("div", {className: "line", style: {position: "absolute", background: this.state.mode == "minute" ? "#c0e5f7": "gray", height: "3px", borderRadius: "3px", marginTop: "50%", width: "35%", marginLeft: "15%", transform: "rotate(" + m + "deg)", transformOrigin: "right center", transition: "all 0.2s ease"}}
				), 
				React.createElement(Times, {ref: "times", mode: this.state.mode})
			)
		}
	});
		...
		render: function() {
			...
			return (
				React.createElement("div", null, 
					...
					React.createElement(Clock, {onChange: this.setTime}), 
					React.createElement("input", {name: "datetime", ref: "input"})
				)
			);
		}
	});
